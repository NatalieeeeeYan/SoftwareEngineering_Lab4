...
public class CartController {
    ...
    public Result<List<CartGoodsPlus>> showList(@RequestParam Integer userId){
        ...
        for(CartGoods cartGoods:list){
            ...
            Event event = eventMapper.selectById(goods.getEventId());
            if(event == null){
                event = new Event(0,null,null,0f,0f,0f,0f,0,0,0,null);
            }
            goodsList.add(new CartGoodsPlus(goods,cartGoods,event));
        }
